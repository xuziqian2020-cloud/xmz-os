...
describe("learning center persistence", () => {
  it("creates learner-owned progress, notes, attempts, and project evidence tables with RLS", () => {
    ...
    assert.match(source, /GRANT SELECT, INSERT, UPDATE, DELETE ON learning_progress TO authenticated/)
    assert.match(source, /GRANT SELECT, INSERT, UPDATE, DELETE ON learning_notes TO authenticated/)
    assert.match(source, /GRANT SELECT, INSERT, UPDATE, DELETE ON learning_code_attempts TO authenticated/)
    assert.match(source, /GRANT SELECT, INSERT, UPDATE, DELETE ON learning_project_evidence TO authenticated/)
    assert.match(source, /GRANT SELECT, INSERT, UPDATE, DELETE ON learning_project_reviews TO authenticated/)
